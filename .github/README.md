...
- **Office exports**: pptx / docx on the same version ladder — the PDF is exported in Office and stamped, CI checks the stamp, and the release carries the source and the PDF
